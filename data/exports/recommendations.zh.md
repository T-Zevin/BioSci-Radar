...
- 生成时间：2026-05-12T14:15:18
- 检索窗口：最近 7 天
- 论文数量：32
- 来源统计：{'PubMed': 8, 'bioRxiv': 8, 'medRxiv': 8, 'arXiv': 8}
...
- **评分**：0.46
- **来源**：bioRxiv
- **作者**：Ebbert, M. T. W., Ho, A., Page, M. L., Dutch, B., Byer, B. K., Hankins, K. L., Sabra, H., Aguzzoli Heberle, B.
- **研究方向**：生物基础模型
- **组学**：无
- **算法方向**：Transformer
- **推荐理由**：匹配方向：生物基础模型；算法相关：Transformer
- **链接**: https://doi.org/10.1101/2025.04.09.647946
...
- **评分**：0.42
- **来源**：medRxiv
- **作者**：Howard, F. M., Li, A., Kochanny, S., Sullivan, M., Flores, E. M., Dolezal, J., Khramtsova, G., Jain-Liu, S.
- **研究方向**：肿瘤多组学、生存与临床预测
- **组学**：无
- **算法方向**：生存模型
- **推荐理由**：匹配方向：肿瘤多组学、生存与临床预测；算法相关：生存模型
- **链接**: https://doi.org/10.64898/2026.04.23.26351499
...
- **评分**：0.37
- **来源**：medRxiv
- **作者**：Yoshinari, G. H., Goulart, W. C. S., Urbano, A. B. O., Rabello, M. M., Zorzetto, M. M., Macedo, S. O. d., Vitorino, L. M.
- **研究方向**：肿瘤多组学
- **组学**：无
- **算法方向**：Transformer
- **推荐理由**：匹配方向：肿瘤多组学；算法相关：Transformer
- **链接**: https://doi.org/10.1101/2025.11.14.25340276
...
- **评分**：0.25
- **来源**：PubMed
- **作者**：Huang X, Luo T, Ke L, Guan S, Wu H, Li B, Liu Y, Qi J
- **研究方向**：肿瘤多组学、组学深度学习
- **组学**：bulk RNA-seq、表观组学
- **算法方向**：无
- **推荐理由**：匹配方向：肿瘤多组学、组学深度学习；涉及组学：bulk RNA-seq、表观组学
- **链接**: https://pubmed.ncbi.nlm.nih.gov/42084802/
...
- **评分**：0.12
- **来源**：medRxiv
- **作者**：Mazhar, A., Rasheed, A., Khakwani, S., Hoodbhoy, Z.
- **研究方向**：无
- **组学**：无
- **算法方向**：无
- **推荐理由**：关键词弱匹配，可能仍值得快速浏览
- **链接**: https://doi.org/10.64898/2026.05.03.26352346
...
- **评分**：0.10
- **来源**：PubMed
- **作者**：Wang L, Wang H, Liu T, Zhang N, Zhao L
- **研究方向**：生存与临床预测
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：生存与临床预测
- **链接**: https://pubmed.ncbi.nlm.nih.gov/42101474/
...
- **评分**：0.25
- **来源**：PubMed
- **作者**：Walberg Å, Reuss AM, Ziadlou R, Mamie C, Gottier C, White A, Ameri M, Brüggen MC
- **研究方向**：生物信息学多组学、单细胞与空间组学、肿瘤多组学
- **组学**：bulk RNA-seq、空间组学
- **算法方向**：无
- **推荐理由**：匹配方向：生物信息学多组学、单细胞与空间组学；涉及组学：bulk RNA-seq、空间组学
- **链接**: https://pubmed.ncbi.nlm.nih.gov/42084500/
...
- **评分**：0.21
- **来源**：medRxiv
- **作者**：Vo, J. N., Wu, Y.-M., Wang, R., Pham, T., Cao, X., Yeung, S., Park, M., Kleyman-Smith, Y.
- **研究方向**：肿瘤多组学
- **组学**：表观组学
- **算法方向**：无
- **推荐理由**：匹配方向：肿瘤多组学；涉及组学：表观组学
- **链接**: https://doi.org/10.64898/2026.05.05.26351600
...
- **评分**：0.18
- **来源**：bioRxiv
- **作者**：Da-Anoy, J., Chen, M.-H., Bouchie, A., Dougherty, J., Lapadula, A., Skena, A., Wang, W., Abraham, T.
- **研究方向**：组学深度学习
- **组学**：bulk RNA-seq
- **算法方向**：无
- **推荐理由**：匹配方向：组学深度学习；涉及组学：bulk RNA-seq
- **链接**: https://doi.org/10.1101/2025.11.05.684850
...
- **评分**：0.17
- **来源**：medRxiv
- **作者**：Waltmann, A., Puerto-Meredith, S. M., Chinkhumba, J., Mzembe, E., Kayange, M., Carroll, I., Roach, J., Mathanga, D. P.
- **研究方向**：生物信息学多组学
- **组学**：微生物组
- **算法方向**：无
- **推荐理由**：匹配方向：生物信息学多组学；涉及组学：微生物组
- **链接**: https://doi.org/10.64898/2026.05.03.26352319
...
- **评分**：0.16
- **来源**：PubMed
- **作者**：Lécuelle J, Truntzer C, Basile D, Laghi L, Greco L, Ilie A, Rageot D, Huppé T
- **研究方向**：肿瘤多组学、组学深度学习
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：肿瘤多组学、组学深度学习
- **链接**: https://pubmed.ncbi.nlm.nih.gov/42100890/
...
- **评分**：0.15
- **来源**：bioRxiv
- **作者**：Trimble, A. S., Kubota, C. S., Zhao, E., Ruchhoeft, M. L., Weitz, J. R., Jung, W., Peck, K. L., Ogawa, S.
- **研究方向**：单细胞与空间组学、肿瘤多组学
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：单细胞与空间组学、肿瘤多组学
- **链接**: https://doi.org/10.64898/2026.04.14.718544
...
- **评分**：0.15
- **来源**：PubMed
- **作者**：Namakshenas P, Crezee J, Kok HP
- **研究方向**：肿瘤多组学
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：肿瘤多组学
- **链接**: https://pubmed.ncbi.nlm.nih.gov/42108654/
...
- **评分**：0.15
- **来源**：bioRxiv
- **作者**：Debic, S., Zheng, X., Hu, J., Kristiani, L., Marsela, R., Kim, Y., Zheng, Y.
- **研究方向**：组学深度学习
- **组学**：bulk RNA-seq
- **算法方向**：无
- **推荐理由**：匹配方向：组学深度学习；涉及组学：bulk RNA-seq
- **链接**: https://doi.org/10.64898/2026.04.30.722071
...
- **评分**：0.14
- **来源**：PubMed
- **作者**：Kojimahara S, Tominaga K, Yamamiya A, Kanazawa M, Tanaka T, Sugaya T, Katoh N, Irisawa A
- **研究方向**：肿瘤多组学
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：肿瘤多组学
- **链接**: https://pubmed.ncbi.nlm.nih.gov/42111927/
...
- **评分**：0.14
- **来源**：medRxiv
- **作者**：Boscenco, S., Castillon, V. J., Wang, J., Tse, E., Freeman, S. S., Bakouny, Z., Mohan, S., Guo, X. A.
- **研究方向**：无
- **组学**：无
- **算法方向**：无
- **推荐理由**：关键词弱匹配，可能仍值得快速浏览
- **链接**: https://doi.org/10.64898/2026.05.04.26352250
...
- **评分**：0.13
- **来源**：bioRxiv
- **作者**：Buecking, J., Güler, B. E., Eibl, M., Ali, A. S., Walczuch, T., Beschauner, T., Theiss, S., Spanjaard, M.
- **研究方向**：生物信息学多组学、组学深度学习
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：生物信息学多组学、组学深度学习
- **链接**: https://doi.org/10.64898/2026.05.01.722223
...
- **评分**：0.13
- **来源**：PubMed
- **作者**：Notohardjo JCL, Toffoli EC, Muijlwijk T, van den Hout MFCM, Kandiah V, Labots M, van de Ven R, van den Eertwegh AJM
- **研究方向**：肿瘤多组学
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：肿瘤多组学
- **链接**: https://pubmed.ncbi.nlm.nih.gov/42093471/
...
- **评分**：0.12
- **来源**：medRxiv
- **作者**：Alegbe, T., Harris, B. T., Fachal, L., Ramirez Navarro, L., Tutert, M., Krzak, M., Ghouraba, M., Strickland, M.
- **研究方向**：无
- **组学**：无
- **算法方向**：无
- **推荐理由**：关键词弱匹配，可能仍值得快速浏览
- **链接**: https://doi.org/10.1101/2025.06.24.25330216
...
- **评分**：0.12
- **来源**：bioRxiv
- **作者**：Miranda, O. A., Contreras, X., Pauler, F. M., Davaatseren, A., Amberg, N., Streicher, C., Villalba, A., Heger, A.
- **研究方向**：单细胞与空间组学
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：单细胞与空间组学
- **链接**: https://doi.org/10.64898/2026.05.01.722191
...
- **评分**：0.08
- **来源**：PubMed
- **作者**：Zhao Z, Shi R, Ye J, Wang D, Zhao B, Ren B, Wang L, Liu X
- **研究方向**：生物信息学多组学、组学深度学习
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：生物信息学多组学、组学深度学习
- **链接**: https://pubmed.ncbi.nlm.nih.gov/42105281/
...
- **评分**：0.28
- **来源**：bioRxiv
- **作者**：Ohlan, R., Murugan, R., Xie, L., Nallabolu, V., Mottaqi, M., Zhang, S., Xie, L.
- **研究方向**：生物信息学多组学、单细胞与空间组学、组学深度学习
- **组学**：bulk RNA-seq
- **算法方向**：对比学习
- **推荐理由**：匹配方向：生物信息学多组学、单细胞与空间组学；涉及组学：bulk RNA-seq；算法相关：对比学习
- **链接**: https://doi.org/10.1101/2025.02.19.638723
...
- **组学**：无
- **算法方向**：多模态
- **推荐理由**：匹配方向：组学深度学习；算法相关：多模态；提到代码
...
- **评分**：0.20
- **来源**：bioRxiv
- **作者**：Hamilton, T., Sparta, B., Cooley, S. M., Aragones, S. D., Ray, J. C. J., Deeds, E. J.
- **研究方向**：单细胞与空间组学
- **组学**：bulk RNA-seq、scRNA-seq
- **算法方向**：无
- **推荐理由**：匹配方向：单细胞与空间组学；涉及组学：bulk RNA-seq、scRNA-seq
- **链接**: https://doi.org/10.1101/689851
...
- **研究方向**：生物基础模型
- **组学**：无
- **算法方向**：Transformer、扩散模型
- **推荐理由**：匹配方向：生物基础模型；算法相关：Transformer、扩散模型
...
- **评分**：0.15
- **来源**：arXiv
- **作者**：Wei Chow, Linfeng Li, Xian Sun, Lingdong Kong, Zefeng Li, Qi Xu, Hang Song, Tian Ye
- **研究方向**：生物基础模型
- **组学**：无
- **算法方向**：Transformer
- **推荐理由**：匹配方向：生物基础模型；算法相关：Transformer
...
- **评分**：0.15
- **来源**：medRxiv
- **作者**：Enywaku, A., Asiku, R. A.
- **研究方向**：组学深度学习
- **组学**：无
- **算法方向**：无
- **推荐理由**：匹配方向：组学深度学习
- **链接**: https://doi.org/10.64898/2026.05.04.26352354
